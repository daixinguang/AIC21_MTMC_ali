...
class PostLinker(nn.Module):
    def __init__(self):
        ...
        self.FusionBlock_1 = FusionBlock(512, 512)
        self.FusionBlock_2 = FusionBlock(512, 512)
    ...
    def forward(self, x1, x2):
        x1 = x1[:, :, :, :3]
        x2 = x2[:, :, :, :3]
        x1 = self.TemporalModule_1(x1)  # [B,1,30,3] -> [B,256,6,3] 300->276
...
if __name__ == '__main__':
    x1 = torch.ones((2, 1, 300, 3))
    x2 = torch.ones((2, 1, 300, 3))
    m = PostLinker()
    y = m(x1, x2)
    print(y)